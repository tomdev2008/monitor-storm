package com.lvtu.monitor.storm.entity.bak;

import java.io.Serializable;
import java.util.Map;

/** 
* @Title: NginxLogByLua.java 
* @Package com.lvtu.monitor.storm.entity 
* @Description: nginx lua插件记录的日志(backup,即将过时)
* @author lvzimin 
* @date 2015年5月25日 上午10:06:28 
* @version V1.0.0 
*/
public class NginxLogByLua implements Serializable {
